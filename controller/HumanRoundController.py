    ...
    def round(self, player: Player, board: Board):
        ...
        while (flag == False):
            ...
            if sp == "hint" or sp == "HINT":
                if player == board.getPlayer1(): move = minMaxController.alpha_beta_cutoff_search(State(board, board.getPlayer1(),board.getPlayer2(),board.getPlayer1(),board.getPlayer2()),3,4)
                else: move = minMaxController.alpha_beta_cutoff_search(State(board, board.getPlayer2(),board.getPlayer1(),board.getPlayer2(),board.getPlayer1()),3,4)
