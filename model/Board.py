...
class Board:
    def __init__(self, isPlayer1Bot: bool, isPlayer2Bot: bool):
        # Generate the board
            ...
            self.Animals1 = [p1, w1, d1, c1]
            self.Animals2 = [p2, w2, d2, c2]
            ...
            self.matrix[1][5].animal = self.Animals2[3]
            self.matrix[1][1].animal = self.Animals2[2]
            self.matrix[2][4].animal = self.Animals2[1]
            self.matrix[2][2].animal = self.Animals2[0]
            ...
            self.matrix[7][1].animal = self.Animals1[3]
            self.matrix[7][5].animal = self.Animals1[2]
            self.matrix[6][2].animal = self.Animals1[1]
            self.matrix[6][4].animal = self.Animals1[0]
